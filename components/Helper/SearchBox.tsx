...
const SearchBox = () => {
  return (
    <div className='bg-white opacity-50  p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 items-center justify-center gap-8 mt-4 sm:mt-12 w-[80%] sm:w-[80%] xl:w-[70%]'>
        {/* ist Search Input  */}
